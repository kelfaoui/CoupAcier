    ...
    <>
      <main>
        <div className="bg-white">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-black  main-h2 inline-block mx-auto"><span>Demande de devis</span></h2>
            <section className="mt-5 text-left">
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-8 my-10">
                <div className="group relative p-5 bg-white rounded-xl">
                  {/* <div className="election:aspect-h-1 aspect-w-1 w-full overflow-hidden bg-white-200 lg:aspect-none group-hover:opacity-75 lg:h-50 items-left flex">
                    <label className="w-full font-bold">Je suis :
                      <select  className="bg-gray-300 p-2 w-full mt-2 rounded" name="pro">
                ...
                <div className="group relative p-5 bg-white rounded-xl">
                  <div className="election:aspect-h-1 aspect-w-1 w-full overflow-hidden bg-white-200 lg:aspect-none group-hover:opacity-75 lg:h-50 items-left flex">
                    <label className="w-full font-bold">Description du projet :
                      <textarea rows={10} className="bg-gray-300 p-2 w-full mt-2 rounded" type="password">
