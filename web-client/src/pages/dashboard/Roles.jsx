...
function DashboardRoles() {
  ...
  return (
    <div className="rounded w-full p-5 flex">
      ...
      <a class="bg-yellow-400 rounded-xl py-2 px-24 mb-10 text-xl font-bold border-white" href="#"><i>Roles</i></a><hr className="-mt-3" ></hr>
      <table border={1} className="mt-10 border-collapse table-auto text-sm bg-white text-left mb-20 w-full ">
        <thead className="border">
          <th className="p-3 border" >Id</th>
          <th className="p-3 border" >Nom role</th>
