...
import { ChevronDownIcon, PhoneIcon, PlayCircleIcon, HeartIcon, ShoppingCartIcon, UserIcon } from '@heroicons/react/20/solid'
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            <img className="h-8 w-auto" src={viteLogo} alt="" />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="/produits" className="text-sm font-semibold leading-6 text-gray-900">
            Produits
          </a>
